...
#define FILTER_DESC "Filter plugin for video editing via scripting."
#define FILTER_DESCW L"Filter plugin for video editing via scripting."
...
#define FILTER_VERSION 1,2,1,0
#define FILTER_VERSION_STRING "1.2.1"
